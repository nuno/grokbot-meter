...
| [`popup.png`](popup.png) | Main popover — Weekly (no spark), Today, footer |

## Capture notes

- Prefer a current release build (`releases/<ver>/` or `dist/mac-arm64/GrokBot Meter.app`).
...
- Crop tidy retina PNGs; redact account email if it ever appears.
